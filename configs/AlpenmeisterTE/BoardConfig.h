...
#define GPIO_PIN_29 GpioAction::BUTTON_PRESS_A2     // A2     | ~      | Capture | Touchpad | 14     | ~      |
...
#define LED_BRIGHTNESS_MAXIMUM 25
...
CASE_RGB_TYPE CASE_RGB_TYPE_STATIC
CASE_RGB_INDEX 14
CASE_RGB_COUNT 8
CASE_RGB_COLOR ColorWhite

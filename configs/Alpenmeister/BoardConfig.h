...
#define DEFAULT_BOARD_LAYOUT_A {\
    {GP_ELEMENT_BTN_BUTTON, {7, 35, 7, 6, 1, 1, GAMEPAD_MASK_L3,       GP_SHAPE_ELLIPSE}},\
    {GP_ELEMENT_DIR_BUTTON, {25, 16, 6, 6, 1, 1, GAMEPAD_MASK_LEFT,    GP_SHAPE_ELLIPSE}},\
    {GP_ELEMENT_DIR_BUTTON, {35, 16, 6, 6, 1, 1, GAMEPAD_MASK_DOWN,    GP_SHAPE_ELLIPSE}},\
    {GP_ELEMENT_DIR_BUTTON, {43, 25, 6, 6, 1, 1, GAMEPAD_MASK_RIGHT,   GP_SHAPE_ELLIPSE}},\
    {GP_ELEMENT_DIR_BUTTON, {55, 55, 7, 7, 1, 1, GAMEPAD_MASK_UP,      GP_SHAPE_ELLIPSE}},\
}

#define DEFAULT_BOARD_LAYOUT_B {\
    {GP_ELEMENT_DIR_BUTTON, {61, 32, 7, 6, 1, 1, GAMEPAD_MASK_L1,      GP_SHAPE_ELLIPSE}},\

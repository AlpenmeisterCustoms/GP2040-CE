...
#define DEFAULT_BOARD_LAYOUT_A {\
    {GP_ELEMENT_BTN_BUTTON, {4, 24, 7, 7, 1, 1, GAMEPAD_MASK_L3,       GP_SHAPE_ELLIPSE}},\
//    {GP_ELEMENT_BTN_BUTTON, {7, 24, 7, 7, 1, 1, GAMEPAD_MASK_L3,       GP_SHAPE_ELLIPSE}},\
    {GP_ELEMENT_DIR_BUTTON, {21, 17, 6, 6, 1, 1, GAMEPAD_MASK_LEFT,    GP_SHAPE_ELLIPSE}},\
    {GP_ELEMENT_DIR_BUTTON, {36, 17, 6, 6, 1, 1, GAMEPAD_MASK_DOWN,    GP_SHAPE_ELLIPSE}},\
    {GP_ELEMENT_DIR_BUTTON, {48, 25, 6, 6, 1, 1, GAMEPAD_MASK_RIGHT,   GP_SHAPE_ELLIPSE}},\
...
#define DEFAULT_BOARD_LAYOUT_B {\
    ...
    {GP_ELEMENT_BTN_BUTTON, {117,24, 7, 7, 1, 1, GAMEPAD_MASK_R3,      GP_SHAPE_ELLIPSE}},\
